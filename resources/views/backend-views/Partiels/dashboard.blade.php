    ...
    <h3 class="card-title align-items-start flex-column text-white pt-15">
        ...
        <div class="fs-4 text-white">
            ...
            <span class="position-relative d-inline-block">
                <a href="/metronic8/demo58/pages/user-profile/projects.html" class="link-white opacity-75-hover fw-bold d-block mb-1">4 tasks</a>
...
<div class="card-body d-flex ps-xl-15">          
    ...
    <div class="m-0">
        ...
        <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-7">
            <span class="me-2">
                ...
                <span class="position-relative d-inline-block text-danger">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-danger opacity-75-hover">2300 bonus</a>  
        ...
        <div class="mb-3">
            ...
            <a href="/metronic8/demo58/apps/support-center/overview.html" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold">
                How to
            </a> 
        </div>
        <!--begin::Action--> 
    ...
    <!--begin::Illustration-->
    <img src="{{asset('backend-assets')}}/media/illustrations/sigma-1/17-dark.png" class="position-absolute me-3 bottom-0 end-0 h-200px" alt=""/> 
    <!--end::Illustration-->
</div>
<!--end::Body-->
</div>
...
<div class="card-body pt-6">
        ...
        <div class="d-flex flex-stack">  
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                ...
                <div class="flex-grow-1 me-2">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">UI/UX Design</a>
        ...
        <div class="d-flex flex-stack">  
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->                    
                <div class="flex-grow-1 me-2">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">QA Analysis</a>
        ...
        <div class="d-flex flex-stack">  
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->                    
                <div class="flex-grow-1 me-2">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Web Development</a>
        ...
        <div class="d-flex flex-stack">  
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->                    
                <div class="flex-grow-1 me-2">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Marketing</a>
        ...
        <div class="d-flex flex-stack">  
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->                    
                <div class="flex-grow-1 me-2">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Philosophy</a>
        ...
        <div class="d-flex flex-stack">  
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->                    
                <div class="flex-grow-1 me-2">
                    <a href="/metronic8/demo58/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Mathematics</a>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="kt_timeline_widget_1_tab_day" role="tabpanel" aria-labelledby="day-tab" data-kt-timeline-widget-1-blockui="true">
            <div class="table-responsive pb-10">
                <!--begin::Timeline-->
                <div id="kt_timeline_widget_1_1" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="{{asset('backend-assets')}}/media/"></div>
                <!--end::Timeline-->
            </div>
        </div>
        <!--end::Tab pane-->
        ...
        <div class="tab-pane" id="kt_timeline_widget_1_tab_week" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-1-blockui="true">
            <div class="table-responsive pb-10">
                <!--begin::Timeline-->
                <div id="kt_timeline_widget_1_2" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="{{asset('backend-assets')}}/media/"></div>
                <!--end::Timeline-->
            </div>
        </div>
        <!--end::Tab pane-->
        ...
        <div class="tab-pane" id="kt_timeline_widget_1_tab_month" role="tabpanel" aria-labelledby="month-tab" data-kt-timeline-widget-1-blockui="true">
            <div class="table-responsive pb-10">
                <!--begin::Timeline-->
                <div id="kt_timeline_widget_1_3" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-1-image-root="{{asset('backend-assets')}}/media/"></div>
                <!--end::Timeline-->
            </div>
        </div>
        <!--end::Tab pane-->
...
<div class="card-body pt-5">                 
        ...
        <div class="d-flex flex-stack">                 
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->                         
                <img src="{{asset('backend-assets')}}/media/svg/brand-logos/laravel-2.svg" class="me-4 w-30px" alt=""/>                  
                <!--end::Logo-->
        ...
        <div class="d-flex flex-stack">                 
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->                         
                <img src="{{asset('backend-assets')}}/media/svg/brand-logos/vue-9.svg" class="me-4 w-30px" alt=""/>                  
                <!--end::Logo-->
        ...
        <div class="d-flex flex-stack">                 
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->                         
                <img src="{{asset('backend-assets')}}/media/svg/brand-logos/bootstrap5.svg" class="me-4 w-30px" alt=""/>                  
                <!--end::Logo-->
        ...
        <div class="d-flex flex-stack">                 
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->                         
                <img src="{{asset('backend-assets')}}/media/svg/brand-logos/angular-icon.svg" class="me-4 w-30px" alt=""/>                  
                <!--end::Logo-->
        ...
        <div class="d-flex flex-stack">                 
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->                         
                <img src="{{asset('backend-assets')}}/media/svg/brand-logos/spring-3.svg" class="me-4 w-30px" alt=""/>                  
                <!--end::Logo-->
        ...
        <div class="d-flex flex-stack">                 
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->                         
                <img src="{{asset('backend-assets')}}/media/svg/brand-logos/typescript-1.svg" class="me-4 w-30px" alt=""/>                  
                <!--end::Logo-->
